...
void main() {
        ...
        vec2 displacedUv = textureCoord + cnoise(vec3(textureCoord * 1.0, u_time * 0.002 + u_mouse.y * 0.3)) * u_noisyEffect;
        vec2 strength = displacedUv + cnoise(vec3(displacedUv * 2.0, u_time * 0.002 + u_mouse.x * 0.3 )) * u_noisyEffect;
